...
impl SerialPort {
    ...
    pub const unsafe fn new(base: u16) -> Self {
        Self {
            data: Port { port: base, unused: PhantomData },
            int_en: Port { port: base + 1, unused: PhantomData },
            fifo_ctrl: Port { port: base + 2, unused: PhantomData },
            line_ctrl: Port { port: base + 3, unused: PhantomData },
            modem_ctrl: Port { port: base + 4, unused: PhantomData },
            line_sts: Port { port: base + 5, unused: PhantomData },
        }
    }
